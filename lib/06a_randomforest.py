...
## load data
X_train = pd.read_csv("../output/05/x_train_alc.csv", index_col=0, header=0)
y_train = pd.read_csv("../output/05/y_train_alc.csv", index_col = 0, header = 0 )
sw_train = pd.read_csv("../output/05/sw_train_alc.csv", index_col = 0, header = 0 )
x_test = pd.read_csv('../output/05/x_test_alc.csv', index_col=0)
y_test = pd.read_csv('../output/05/y_test_alc.csv', index_col=0)
